...
import { compactButtonVariants } from "@/ui/compact-button";

// Icon components defined outside to avoid nested component definitions
const IconLeft = () => <RiArrowLeftSLine className="size-5" />;
const IconRight = () => <RiArrowRightSLine className="size-5" />;
